...
function f(but){	
	test = $(but).text()
	location.href="/LRA_20201209/lecture/info.do?lectureKeyword="+test;
...
function listFunc(){
			...
			success : function(obj) {
				...
				case 0:
					...
					obj.keywordlist.forEach(function(member) {
						buffer.push("<a onclick=f(this) href='#'>"+member.lectureKeyword + "</a><br/>");
					});
	...
	function bSubmit() {
		...
		var arry = $("#listContainer").html().split("</a><br>").split("<a href='#'>")
